<?php
	...
	$transformFunctions = [
		'snacks' => function($data, $options = []) {

			return $data;
		},
		'ratings' => function($data, $options = []) {

			return $data;
		},
		'favorites' => function($data, $options = []) {
	...
	$filterFunctions = [
		'snacks' => function($data, $options = []) { return true; },
		'ratings' => function($data, $options = []) { return true; },
		'favorites' => function($data, $options = []) { return true; },
	];
