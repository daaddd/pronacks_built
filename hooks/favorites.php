<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'favorites' table. 
	...
	*/
	...
	function favorites_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function favorites_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function favorites_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function favorites_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function favorites_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['member'], $data['snacks']
	...
	*/
	...
	function favorites_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function favorites_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function favorites_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function favorites_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function favorites_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function favorites_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function favorites_batch_actions(&$args) {
