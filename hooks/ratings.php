<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'ratings' table. 
	...
	*/
	...
	function ratings_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function ratings_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function ratings_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['member'], $data['snackid'], $data['rating']
	...
	*/
	...
	function ratings_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function ratings_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['member'], $data['snackid'], $data['rating']
	...
	*/
	...
	function ratings_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function ratings_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function ratings_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function ratings_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function ratings_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function ratings_batch_actions(&$args) {
