<?php
	...
	$dbUsername = 'root';
	$dbPassword = '';
	$dbDatabase = 'pronacks_built';
	$dbPort = '3306';
	$appURI = 'pronacks_built';
	$host = 'localhost:9090';

	$adminConfig = [
		'adminUsername' => "admin",
		'adminPassword' => "\$2y\$10\$l4IgE/1UFlgnIWJ0vgdNVeGHA/ub7xWXO6Hmiw/7pR8TbUtFJ7U4C",
