	...
	if($thisMD5 != $prevMD5) {
		...
		setupTable(
			...
			CREATE TABLE IF NOT EXISTS `snacks` ( 
				...
				`Illustration` VARCHAR(80) NULL,
				`serving_size` VARCHAR(80) NULL,
				`calories` VARCHAR(80) NULL,
				`fat` VARCHAR(80) NULL,
				`carbs` VARCHAR(80) NULL,
				`protein` VARCHAR(80) NULL,
				`fiber` VARCHAR(80) NULL,
				`sodium` VARCHAR(80) NULL,
				`am_link` VARCHAR(80) NULL,
